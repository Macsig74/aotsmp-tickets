...
module.exports = {
  ...
  async execute(interaction) {
    ...
    modal.addComponents(
      ...
      new ActionRowBuilder().addComponents(
        new TextInputBuilder().setCustomId('whereami').setLabel('Résultat de /whereami ✦ OBLIGATOIRE')
      ...
      new ActionRowBuilder().addComponents(
        new TextInputBuilder().setCustomId('probleme').setLabel('Décris le problème ✦ OBLIGATOIRE')
